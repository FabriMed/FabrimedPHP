...
!function(b) {
    ...
    a.prototype = {constructor: a, init: function(d) {
            ...
            var d = "<div class='btn-group bootstrap-select" + c + "'><button type='button' class='btn btn-small dropdown-toggle' data-toggle='dropdown'><div class='filter-option pull-left'></div>&nbsp;<div class='caret'></div></button><div class='dropdown-menu open'>" + f + e + "<ul class='dropdown-menu inner' role='menu'></ul></div></div>";
            return b(d)
        }, createView: function() {
            ...
            var g = this.options.header ? e.find(".bootstrap-select-searchbox").outerHeight() : 0;
            f.remove();
